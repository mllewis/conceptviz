...
pairwise_means <- tree_clean %>%
  ...
  summarize(mean_cosine = mean(cosine),
            sd = sd(cosine),
            norm_mean = mean_cosine/mean(c(country_sd_1[1], country_sd_2[1])),
            norm_mean2 = mean_cosine/sum(c(country_sd_1[1], country_sd_2[1])),
            norm_mean3 = mean_cosine/country_sd_1[1],
            norm_mean4 = mean_cosine/country_sd_2[1],
            norm_mean5 = mean_cosine/mean(c(country_mean_1[1], country_mean_2[1])),
            norm_mean6 = mean_cosine/sum(c(country_mean_1[1], country_mean_2[1])),
            norm_mean7 = mean_cosine/country_mean_1[1],
            norm_mean8 = mean_cosine/country_mean_2[1]) %>%
  rowwise() %>%
